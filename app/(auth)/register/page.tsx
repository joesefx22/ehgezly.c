...
export default function RegisterPage() {
  ...
  const skillLevels = [
    { value: 'WEAK', label: 'ضعيف', desc: 'مبتدئ', icon: '😅' },
    { value: 'AVERAGE', label: 'متوسط', desc: 'لديه خبرة', icon: '😊' },
    { value: 'GOOD', label: 'جيد', desc: 'متمكن', icon: '😎' },
    { value: 'EXCELLENT', label: 'ممتاز', desc: 'محترف', icon: '🔥' },
    { value: 'LEGENDARY', label: 'أسطوري', desc: 'خبير', icon: '👑' }
  ]
